...
function ActivityDashboard() {
    ...
    //         activityStore.setActivity(activitiesMatched[0]);
    //     }
    // }
      ...
      return (
        <Grid>
            <Grid.Row>
                ...
                <Grid.Column width={3}>
                    {activityStore.activity !== null && !activityStore.isDisplayCreateForm && <ActivityDetail></ActivityDetail>}
                    {activityStore.isDisplayCreateForm && <ActivityForm />}
                </Grid.Column>
                {/* <Grid.Column width={3}>
                    {activityStore.activity !== null && !isDisplayForm && <ActivityDetail activityDetailCancelled={() => setActivity(null as any)} activityDetail={activity} onActivityDetailUpdated={onActivityDetailUpdated}></ActivityDetail>}
